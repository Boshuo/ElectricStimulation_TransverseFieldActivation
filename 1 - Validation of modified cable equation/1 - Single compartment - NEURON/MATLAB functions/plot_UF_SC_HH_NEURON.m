...
threshold_axon = threshold.E'*10;           % Convert from mV/mm to mV/cm; 1 mV/cm = 10 mV/mm
R_vec_axon =  R_vec * 1e-4;                 % Compartment radius, in cm;
...
threshold_soma = threshold.E'*10;           % Convert from mV/mm to mV/cm; 1 mV/cm = 10 mV/mm
R_vec_soma =  R_vec * 1e-4;                 % Compartment radius, in cm;
...
imwrite(    imind,cm,fullfile('Processed data and figures','UF_SC_HH_NEURON.tif'),'tif','WriteMode','overwrite', 'Resolution',300);
saveas(h_f,fullfile('Processed data and figures','UF_SC_HH_NEURON.fig'));
close(h_f);
