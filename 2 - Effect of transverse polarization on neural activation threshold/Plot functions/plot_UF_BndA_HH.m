...
ind_alpha = find(ALPHA(:,1)>=(90/180*pi));
...
contour(ALPHA(:,ind_PW)/pi*180,log10(PPWW(:,ind_PW)),th_per_diff_MCE(:,ind_PW),[-10,-5],'-','LineWidth',1.5,'Color',[1,1,1]*0);

ind_PW = find(PPWW(1,:)<=(0.04));
[C,h]=contour(ALPHA(:,ind_PW)/pi*180,log10(PPWW(:,ind_PW)),th_per_diff_MCE(:,ind_PW),[-10,-5],'-','LineWidth',1.5,'Color',[1,1,1]*0);
