function  [exit_flag, t_end] = simulate_cable_HH(solver, stimulation, cable, plot_options)
...
for t_ind = 2:len_t
    ...
    if is_MCE
        phi_m = repmat( phi_m_bar, [1,n_theta] ) + ER_TP * pulse_shape(t_ind);
    else
        phi_m = phi_m_bar; 
    end
