...
extern Memb_func* memb_func;
 ...
 "setdata_hhh", _hoc_setdata,
 "rates_hhh", _hoc_rates,
 "vtrap_hhh", _hoc_vtrap,
 0, 0
};
#define vtrap vtrap_hhh
...
#define _gth 0
#define htau_hhh _thread1data[0]
#define htau _thread[_gth]._pval[0]
#define hinf_hhh _thread1data[1]
#define hinf _thread[_gth]._pval[1]
#define mtau_hhh _thread1data[2]
#define mtau _thread[_gth]._pval[2]
#define minf_hhh _thread1data[3]
#define minf _thread[_gth]._pval[3]
#define ntau_hhh _thread1data[4]
#define ntau _thread[_gth]._pval[4]
#define ninf_hhh _thread1data[5]
#define ninf _thread[_gth]._pval[5]
#define usetable usetable_hhh
 double usetable = 1;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 19, 7);
 	...
 	ivoc_help("help ?1 hhh D:/Duke Projects/NEURON_IP/SC_HH_IP_v4_newHH_normNa/hhh.mod\n");
...
static int _reset;
static char *modelname = "hhh.mod   squid sodium, potassium, and leak channels";
...
/*CVODE*/
 ...
 static double _mfac_rates, _tmin_rates;
  ...
  if (_maktable) { double _x, _dx; _maktable=0;
   _tmin_rates =  - 2000.0 ;
   _tmax =  2000.0 ;
   _dx = (_tmax - _tmin_rates)/5001.; _mfac_rates = 1./_dx;
   for (_i=0, _x=_tmin_rates; _i < 5002; _x += _dx, _i++) {
...
static void _initlists(){
 ...
 _slist1[2] = &(n) - _p;  _dlist1[2] = &(Dn) - _p;
   _t_minf = makevector(5002*sizeof(double));
   _t_mtau = makevector(5002*sizeof(double));
   _t_hinf = makevector(5002*sizeof(double));
   _t_htau = makevector(5002*sizeof(double));
   _t_ninf = makevector(5002*sizeof(double));
   _t_ntau = makevector(5002*sizeof(double));
_first = 0;
}
