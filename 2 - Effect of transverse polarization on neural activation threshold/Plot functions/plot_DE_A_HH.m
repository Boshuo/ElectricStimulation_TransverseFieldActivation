...
[C,h]=contour(log10(HH/1e-1),log10(PPWW),abs(th_CE)/1e3,10.^(I_log_cnt_min*[1,1]),'-','LineWidth',1.5,'Color',[1,1,1]*0);
...
[C,h]=contour(log10(HH/1e-1),log10(PPWW),abs(th_CE)/1e3,10.^(I_log_cnt_max-1:I_log_cnt_max),'-','LineWidth',1.5,'Color',[1,1,1]*0);
...
clabel(C,h,'FontSize',10,'Interpreter','latex','LabelSpacing',350);
